...
apps_res = api_request("GET", "/apps?filter[bundleId]=com.samvel.armenianbible")
app_id = None
...
for email, fn, ln in emails_to_add:
    ...
    if "data" in res:
        ...
        print(f"ℹ️ Тестировщик {email} уже добавлен!")
    else:
        print(f"👉 Обработан {email}: {res}")

print("✨ Все приглашения обработаны!")
